...
<link rel="stylesheet" href="../Signin/css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
<!-- //Custom Theme files -->
<!-- web font -->
...
<div class="main-agileinfo">
	...
	<div class="videologin">
		<h2 class="sub-head"  style="color:purple;">      </h2>
		<form action="LoginServlet" name="loginForm" method="post">
			<div class="icon1"  align="center">
			...
			<div class="bottom"  align="center">
				<input type="submit" name="submitButton" value="Sign in"  onClick = ""/> 				
			</div>
			<br>
			<div class="clear"></div>
			<div class="bottom">
				<a href="StudentSignUp.jsp"></a> 	
      ...
      <nav class="navbar navbar-default probootstrap-navbar">
        <div class="container">
          <div class="navbar-header">
            ...
            <h3 style="font-family: sans-serif;;font-weight:bold;color:navy;"></h3>
          </div>
