...
<h2 align="center" style="color:white">STUDENT  REGISTRATION  FORM</h2>
<div class="w3ls-main">
<div class="w3ls-form">
<form action="StudentSignUpServlet" method="get" name="StudentRegisteration">
<ul class="fields">
	<li>	
		<label class="w3ls-opt">Student name<span class="w3ls-star"> * </span></label>
		<div class="w3ls-name">	
...
<option>Puducherry</option>
	...
	<li>
		<label class="w3ls-opt">CGPA<span class="w3ls-star"> * </span></label>	
			<span class="w3ls-text w3ls-name">
